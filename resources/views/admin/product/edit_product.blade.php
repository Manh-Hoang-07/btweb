            ...
            <div class="panel-body">
                ...
                <div class="position-center">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" data-validation="length" data-validation-length="min10" data-validation-error-msg="Làm ơn điền ít nhất 10 ký tự" name="brand_name" class="form-control" value="{{ $edit_value->product_name }}">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" name="update_product" class="btn btn-info">Cap nhat thuong hieu</button>
                    </form>
                </div>
                @endforeach
            </div>
